        ...
        View.OnClickListener
{
    ...
    private void getChatMessages(){
        ...
        CollectionReference messagesRef = mDb
                .collection(getString(R.string.collection_familyroom))
                .document(mChatroom.getChatroom_id())
                .collection(getString(R.string.collection_familyroom_messages));
    ...
    private void getChatroomUsers(){
        ...
        CollectionReference usersRef = mDb
                .collection(getString(R.string.collection_familyroom))
                .document(mChatroom.getChatroom_id())
                .collection(getString(R.string.collection_familyroom_user_list));
