...
import com.example.among.UserClient;
import com.example.among.children.map.LocationService;
        ...
        ChatroomRecyclerAdapter.ChatroomRecyclerClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //인텐트 객체에서 공유된 값을 꺼내기
        String msg = intent.getStringExtra("familyRoom");
        Toast.makeText(this,"추출한 값:"+msg,
        ...
        builder.setPositiveButton("CREATE", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if(!input.getText().toString().equals("")){
                    ...
                    Toast.makeText(MainActivity.this, "가족 채팅방 생성", Toast.LENGTH_SHORT).show();
                }
            }
        });
